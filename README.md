...
for **Quasar consensus**, derived from [daryakaviani/corona](https://github.com/daryakaviani/corona) (academic 2-round threshold signature from R-LWE) with the protocol additions needed to operate on a **leaderless open public chain**.
...
The upstream repo at `daryakaviani/corona` is an **academic proof-of-concept** ("not ready for production use" per its README). Corona is the production track:

| Layer | Upstream Corona | Corona |
|---|---|---|
