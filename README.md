...
**Pulsar** is the Lux-evolved post-quantum threshold signature stack for **Quasar consensus**, derived from [daryakaviani/corona](https://github.com/daryakaviani/corona) (academic 2-round threshold signature from LWE) with the protocol additions needed to operate on a **leaderless open public chain**.
