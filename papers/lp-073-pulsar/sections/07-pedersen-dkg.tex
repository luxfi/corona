...
replaces upstream Corona's Feldman commit
...
The upstream Corona DKG at \texttt{corona/dkg/dkg.go} uses Feldman
commits
\begin{equation}
...
review at
\texttt{luxcpp/crypto/corona/RED-DKG-REVIEW.md} (Finding~1)
...
\midrule
Broken \texttt{corona/dkg/} (Feldman, no noise)
        & \emph{none} (linear)
        & statistical
...
Corona \cite{boschini2024corona}: at least 128-bit classical and at least
