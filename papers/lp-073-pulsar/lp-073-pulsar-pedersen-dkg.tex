...
\bibitem{lp020}
LP-020. ``Quasar Consensus: Triple-Sign with BLS, Corona, and ML-DSA.''
\bibitem{lp070}
LP-070. ``ML-DSA-65 Identity Layer for Quasar Validators.''
\bibitem{lp073}
LP-073. ``Corona: A Two-Round MAC-Authenticated Lattice-Based Threshold
Signature.''
\bibitem{boschini2024ringtail}
C. Boschini, D. Kaviani, R. W. F. Lai, G. Malavolta, A. Takahashi and
M. Tibouchi.  ``Ringtail: Practical Two-Round Threshold Signatures from
Learning with Errors.''  Cryptology ePrint Archive, Paper 2024/1113, 2024.
\end{thebibliography}
